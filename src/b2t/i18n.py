...
MESSAGES: dict[str, dict[str, str]] = {
    "zh-CN": {
        ...
        "opt_workspace_help": "工作目录；未指定时复用已有配置，否则使用用户目录下的 .b2t。",
        "opt_host_help": "监听地址。",
        "opt_port_help": "监听端口。",
        ...
        "bootstrap_bailian_api_key_prompt": "百炼 API Key（可留空，使用 DASHSCOPE_API_KEY 环境变量）",
        ...
        "bootstrap_bailian_oss_prefix_prompt": "OSS 音频目录前缀",
        ...
        "provider_bailian_short": "阿里云百炼异步识别，适合云服务器",
        ...
        "progress_message_uploading_audio": "正在上传音频到百炼临时存储",
        "progress_message_submitting_task": "正在提交百炼任务",
        "progress_message_waiting_remote": "等待云端转写完成",
    ...
    "en-US": {
        ...
        "opt_workspace_help": "Workspace root; reuses an existing local config, otherwise uses ~/.b2t.",
        ...
        "bootstrap_bailian_api_key_prompt": "Bailian API key (leave blank to use DASHSCOPE_API_KEY)",
        ...
        "bootstrap_bailian_oss_prefix_prompt": "OSS audio key prefix",
        ...
        "provider_bailian_short": "Alibaba Bailian async ASR for cloud servers",
        ...
        "progress_message_uploading_audio": "Uploading audio to Bailian temporary storage",
        "progress_message_submitting_task": "Submitting Bailian task",
        "progress_message_waiting_remote": "Waiting for cloud transcription",
